            ...
            <div id="leftMenu" class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href=""><i class="fa fa-book fa-fw"></i> Historial académico</a>
                        </li>
                        <li>
                            <a href=""><i class="fa fa-file-text"></i> Evaluación docente</a>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="">Carta Presentación</a>
                                </li>
                                <li>
                                    <a href="">Asignación y aceptación de estadía</a>
                                </li>
                                <li>
                                    <a href="">Resumen estadía</a>
                                </li>
                            </ul>
                        </li>
                        <!--            <li>
