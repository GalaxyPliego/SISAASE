...
<html ng-app="sisa" class="ng-scope" lang="es"><head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="SISAASE_war/bootstrap_1.css" rel="stylesheet">

    <!-- MetisMenu CSS -->
    <link href="SISAASE_war/metisMenu.css" rel="stylesheet">

    <!-- Timeline CSS -->
    <link href="SISAASE_war/general.css" rel="stylesheet">
    <link href="SISAASE_war/timeline.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="SISAASE_war/sb-admin-2.css" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="SISAASE_war/morris.css" rel="stylesheet">
